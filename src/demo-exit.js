...
async function main() {
  ...
  if (first.statusCode !== 402) {
    throw new Error("Expected the first exit-plan request to return 402.");
  }
  ...
  if (second.statusCode !== 200) {
    throw new Error("Expected the paid premium exit request to unlock the resource.");
  }
